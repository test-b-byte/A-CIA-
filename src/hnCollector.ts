...
const primaryUrl = "https://hn.algolia.com/api/v1/search_by_date?tags=story&hitsPerPage=50";
const backupUrl = "https://hn.algolia.com/api/v1/search?tags=front_page";
